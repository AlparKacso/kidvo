...
const IconSearch   = () => <svg width="14" height="14" viewBox="0 0 15 15" fill="none"><path d="M7.5 1.5a5 5 0 1 0 0 10 5 5 0 0 0 0-10Z" stroke="#9590b3" strokeWidth="1.4" fill="none"/><line x1="11" y1="11" x2="14" y2="14" stroke="#9590b3" strokeWidth="1.5" strokeLinecap="round"/></svg>
const IconLocation = () => <svg width="12" height="12" viewBox="0 0 15 15" fill="none"><path d="M7.5 1.5a5 5 0 0 1 5 5c0 3.5-5 8-5 8s-5-4.5-5-8a5 5 0 0 1 5-5Z" stroke="#9590b3" strokeWidth="1.3" fill="none"/><circle cx="7.5" cy="6.5" r="1.5" stroke="#9590b3" strokeWidth="1.3" fill="none"/></svg>
      ...
      <div className="flex md:hidden items-center gap-2 flex-1">
        {searchOpen ? (
          ...
          <>
            ...
            {!isBrowse && <button onClick={() => setSearchOpen(true)} className="w-8 h-8 flex items-center justify-center rounded-full border border-border text-ink-muted hover:border-primary transition-colors">
              <IconSearch />
            </button>}
          </>
        )}
      ...
      <div className="hidden md:flex items-center gap-3 flex-1">
        ...
        <div className="relative flex-1 max-w-[380px]">
          ...
          <input type="text" placeholder="Search activities, providers, areas…"
            className="w-full pl-9 pr-3 py-1.5 border border-border rounded-full bg-bg font-display text-base text-ink placeholder:text-ink-muted outline-none focus:border-primary focus:shadow-focus transition-all"
