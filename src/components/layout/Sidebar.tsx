      ...
      <nav className="flex-1 flex flex-col">
        ...
        {!isProvider && (
          <NavSection label={t('myFamily')} collapsed={collapsed}>
            {/* Kids & Activities is folded into Calendar — its pending-trials badge moved here. */}
            <NavItem href="/kids/calendar" icon={<IconCalendar />} label={t('calendar')} badge={pendingBookings} badgeVariant="blue" collapsed={collapsed} />
          </NavSection>
        )}
