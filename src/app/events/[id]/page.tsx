  ...
  return (
    <AppShell>
      <div className="max-w-[1100px] mx-auto flex flex-col gap-6">
        ...
        {/* Hero */}
        <div className="relative rounded-xl overflow-hidden min-h-[320px] flex flex-col justify-end p-7"
          ...
          {ev.cover_image_url && (
            ...
            <img src={ev.cover_image_url} alt="" className="absolute inset-0 w-full h-full object-cover" />
          )}
        ...
        {/* Action bar */}
        <div className="sticky top-[64px] z-20 bg-bg/85 backdrop-blur-sm rounded-xl border border-border shadow-card px-4 py-3 flex items-center justify-between gap-3 flex-wrap">
